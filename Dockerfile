...
# OnDemand Serverless routes to $PORT (or 3000 when it is absent).  The
# runtime command below maps that platform port to Hermes' API server.
EXPOSE 3000
...
CMD [ "/opt/hermes/docker/serverless-gateway.sh" ]
